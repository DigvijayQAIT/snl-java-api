...
public class Board {
	 ...
	 *                                      on a board where players have already
	 *                                      started movement
	 * @throws MaxPlayersReachedExeption    exception thrown when we try to register
	 *                                      more players than allowed limit for
	 *                                      board
	 * @throws FileNotFoundException
	 * @throws UnsupportedEncodingException
	 */
	 ...
	 *         player and a message specifying the move that was made by the turn
	 *         player
